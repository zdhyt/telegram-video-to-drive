...
def upload_to_drive(
    ...
    # Use the actual downloaded file type.
    mimetype = {
        ".mp4": "video/mp4",
        ".mov": "video/quicktime",
        ".m4v": "video/x-m4v",
...
def download_video(url):
    ...
    command = [
        ...
        # YouTube currently requires a JavaScript runtime
        # for some extraction/challenge steps.
        "--js-runtimes",
        "deno",
...
def main():
    ...
    # --------------------------------------------------------
    # Cloudflare Worker sends these values to GitHub Actions
    ...
    # --------------------------------------------------------
    # Do NOT use Telegram getUpdates here.
    #
    # Telegram is now using a webhook through Cloudflare.
    # --------------------------------------------------------
    ...
    # --------------------------------------------------------
    # Process the single incoming video
    # --------------------------------------------------------
